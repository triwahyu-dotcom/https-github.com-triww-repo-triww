...
export const dictionary: Dictionary = {
  ...
  bankName2: { id: "Nama Bank 2", en: "Bank Name 2" },
  bankAccountNumber2: { id: "Nomor Rekening 2", en: "Account Number 2" },
  bankAccountHolder2: { id: "Nama Pemilik Rekening 2", en: "Account Holder 2" },
